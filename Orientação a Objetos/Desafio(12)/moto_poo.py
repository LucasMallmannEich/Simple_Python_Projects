"""
12 - Baseando-se no exercício anterior, adicione o atributo "ligada", que terá a função de indicar se a moto está
ligada ou não. Este atributo deverá ser do tipo boleano. O método "imprimir" deve ser modificado de forma a mostar na
...
moto1.imprimir()
# Marca: Mitstubishi 	 Modelo: ER-901   Cor: Amarelo 	 Marcha: 4 	 Menor marcha: 4  Maior marcha: 8   Ligada: True
